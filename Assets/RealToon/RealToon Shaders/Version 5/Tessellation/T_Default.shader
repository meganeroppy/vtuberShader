...
Shader "RealToon/Version 5/Tessellation/Default" {
    Properties {
        ...
        _OverallShadowColor ("Overall Shadow Color", Color) = (0,0,0,1)
        ...
        _SelfShadowRealTimeShadowColor ("Self Shadow & Real Time Shadow Color", Color) = (1,1,1,1)
        ...
        _ShadowTColor ("Color", Color) = (1,1,1,1)
		...
		[Toggle(N_F_NLASOBF_ON)] _N_F_NLASOBF ("No Light and Shadow On BackFace", Float ) = 1
    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
				...
				half3 viDir = normalize(_WorldSpaceCameraPos.xyz - o.pos.xyz);
                half4 viDirVP = mul(UNITY_MATRIX_VP, half4(viDir.xyz, 1));
                ...
                float4 node_9403 = _Time;
                float node_8530_ang = node_9403.g;
				...
				o.pos.z = o.pos.z - _OutlineZPostionInCamera * viDirVP.z * 0.1;
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                half3 node_81 = (AL_GI( lerp(float3(node_3622,node_3622,node_3622),float3(node_6794,node_6794,node_6794),lerp( (node_3134*_GIShadeThreshold), float3(smoothstep( float2(node_2183,node_2183), float2(node_8383,node_8383), (node_3134.rb*_GIShadeThreshold) ),0.0), _GIFlatShade )) )*_EnvironmentalLightingIntensity);
