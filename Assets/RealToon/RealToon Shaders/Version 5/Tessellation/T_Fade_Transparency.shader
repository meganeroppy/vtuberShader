...
Shader "RealToon/Version 5/Tessellation/Fade Transparency" {
    Properties {
        ...
        _SelfShadowColor ("Color", Color) = (1,1,1,1)
		...
		[Toggle(N_F_NLASOBF_ON)] _N_F_NLASOBF ("No Light On BackFace", Float ) = 1
    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float node_4658_ang = node_992.g;
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                half node_7861 = lerp((_MainTex_var.a*_MaskTransparency_var.r),_MainTex_var.a,_Opacity);
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                half3 node_9546 = (AL_GI( lerp(float3(node_3622,node_3622,node_3622),float3(node_5898,node_5898,node_5898),lerp( (node_3134*_GIShadeThreshold), float3(smoothstep( float2(node_2183,node_2183), float2(node_8383,node_8383), (node_3134.rb*_GIShadeThreshold) ),0.0), _GIFlatShade )) )*_EnvironmentalLightingIntensity);
