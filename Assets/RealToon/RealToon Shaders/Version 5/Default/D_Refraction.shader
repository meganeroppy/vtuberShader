...
Shader "RealToon/Version 5/Default/Refraction" {
    Properties {
        ...
        _DepthColor ("Color", Color) = (0.5,0.5,0.5,1)
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                half3 node_1243 = (AL_GI( lerp(float3(node_3622,node_3622,node_3622),float3(node_7998,node_7998,node_7998),lerp( (node_3134*_GIShadeThreshold), float3(smoothstep( float2(node_2183,node_2183), float2(node_8383,node_8383), (node_3134.rb*_GIShadeThreshold) ),0.0), _GIFlatShade )) )*_EnvironmentalLightingIntensity);
